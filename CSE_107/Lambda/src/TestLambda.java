...
public class TestLambda {
    public static void main(String[] args) {
        ...
        //If the function has only one parameter then the parenthesis can be omitted.
        //In all other cases the parenthesis should be present.
        ...
        numericTest2 = (a, b) -> (a + b) % 2 == 0;
        //The function parameter need not be matched with the parameter used in the declaration in the interface.
        ...
        factorial = (n) -> { //Writing only "n" instead of "(n)" is also valid.
            int result = 1;
            for (int i = 1; i <= n; i++) {
                result = result * i;
            }
