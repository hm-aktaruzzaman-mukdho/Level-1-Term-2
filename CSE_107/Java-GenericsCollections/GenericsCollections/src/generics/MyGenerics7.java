...
class BoundedWildcard {
    ...
    static void showAll(Coords<? extends FourD> c) {
        /*
         * --> What is the purpose of Using Wild card here?
         * My assumption is that it is done to future proof the implementation.
         * If someone decides to extend the FourD class then this showAll will also work
         * for that.
         */
        for (int i = 0; i < c.coords.length; i++) {
