...
public class Restaurant {
    ...
    Restaurant(int Id,String Name,double Score,String Pricerange,String ZipCode,ArrayList<String> Catagory) {
        this.Id=Id;
        this.Name=Name;
        this.Score=Score;
    ...
    public String getCatagory(int index) {
        //return this.Catagory[index-1];
        return this.getCatagory(index-1);
    }
